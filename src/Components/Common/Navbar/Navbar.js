                ...
                <div className="nav-section bg-[#FFFFFF] w-[100%] z-[1] fixed top-0" >
                    <div style={{ padding: '0% 0%' }} className="">
                        <div className="row align-items-center">
                            ...
                            <div className="col-7 col-md-8 col-lg-3 text-end">
                                <div className=" navbar-expand-lg justify-content-end">
                                    <ul className="navbar-nav mr-[10%] h-list align-items-center float-right">
                                        <li className="nav-item">
                                            <a href="#"><img src={Search} alt="" className=" w-[30px]"></img></a>
                                        </li>
                                        <li className="nav-item">
                                            <NavLink to='/login'><a  href="/login"><img src={User} alt="" className=" w-[30px]"></img></a></NavLink>
                                        </li>
                                        <li className="nav-item">
                                            <a  href="/mycart"><img src={Cart} alt="" className=" w-[30px]"></img></a>
                                        </li>
                                        <li className="nav-item">
                                            <a  href="#"><img src={Language} alt="" className="w-[30px]"></img></a>
                                        </li>
                                        <li className=" menu">
                                            <button type="button" className="navbar-toggle" id="menu-toggle">
                                                <span className="icon-bar"></span>
