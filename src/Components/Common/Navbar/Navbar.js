...
//                                                         <a className="" onClick={() => { setProfileVisible(!profileVisible) }}><img src={User} alt="" className="navIcons ml-3"></img></a>
...
//                         </li>
//                         <li >
//                           <a className="" ><img src={Language} alt="" className="navIcons  ml-3"></img></a>
//                         </li>
                      ...
                      <div className="navbar navbar-expand-lg float-right">
                        <ul className=" mr-auto h-list align-items-center ">
                          ...
                          <li className='px-[6px] inner-nav'>
                            ...
                            <a className="" onClick={() => { setProfileVisible(!profileVisible) }}><img src={User} alt="" className="navIcons ml-3 cursor-pointer"></img></a>
