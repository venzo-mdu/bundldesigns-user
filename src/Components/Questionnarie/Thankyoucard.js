  ...
  return (
    <div>
        ...
        <div className='thankyou-card'>
          ...
          <p className='thank-you-text'>{lang === 'ar' ? 'شكرا لك !' : 'THANK YOU!'}</p>
          <p className='thank-you-desc'>{ lang === 'ar' ? 'سنتواصل معك بأقرب فرصة.' :  'We’ll reach out to you at the earliest convenience.'}</p>
